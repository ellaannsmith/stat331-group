...
co2_cdmt %>%  
  ...
  labs(title = "Average CO2 vs. CDMT", subtitle = "Average CDMT", x = "Average CO2",y = "") + 
  theme_minimal() +  
  theme(plot.title = element_text(size = 20, face = "bold"),      plot.subtitle = element_text(size = 12), 
...
# Step 3: Add regression line to the plot
